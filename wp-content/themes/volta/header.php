...
<body <?php body_class(); ?>>
    ...
    <?php 
        ...
        $logoUploaded = wp_get_attachment_image_src($logo, 'full');
    ?>
    <div class="preloader">
            ...
            <div class="row">
                <div class="col-lg-4 col-sm-5">
                    <div class="topMenusHolder">
                        <ul class="topMenus clearfix poppins">
                            <li>
                                <a href="#"><i class="frontIcon icon-Exit"></i>Register</a>
                            </li>
                            <li>
                                <a href="#" data-toggle="collapse" data-target="#accountTogg">My Account <i class="fa fa-angle-down"></i></a>
                            ...
                            <li>
                                <a href="#"><i class="frontIcon icon-ShoppingCart"></i>5 Items</a>
                            </li>
                        </ul>
                    </div>
                </div>
                <div class="col-lg-4 col-sm-2">
                    <div class="logo text-center">
                        <a href="index-2.html"><img src="<?php echo $logoUploaded[0] ?>" alt="Volta" /></a>
                    </div>
                </div>
                <div class="col-lg-4 col-sm-5">
                ...
                <div class="col-lg-12">
                    <nav class="mainMenu poppins">
                        <div class="logofixedHeader text-center">
                            <a href="index-2.html"><img alt="Volta" src="images/logo.png" /></a>
                        </div>
